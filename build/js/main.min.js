...
exports.createTourSlider = exports.createReviewsSlider = exports.createHeroSlider = exports.createEducationSlider = exports.createAdvSlider = void 0;
...
var createAdvSlider = function createAdvSlider() {
  ...
  if (desktop.matches) {
    if (!init) {
      init = true;
      _swiper.default = (new _swiper.default('.swiper--5', {
        slidesPerView: 3,
        loop: true,
        spaceBetween: 30,
        navigation: {
        ...
        throw new Error('"' + "swiper" + '" is read-only.');
      }());
    }
